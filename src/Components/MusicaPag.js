...
class MusicaPag extends React.Component {
        ...
        return (
            <div>
                <PageHeader ghost={false}>
                    <Descriptions>
                        <Descriptions.Item span={3}><Title level={4}>Música</Title></Descriptions.Item>
                        <Descriptions.Item span={3}>Escucho infinitud de géneros, me encanta apreciar los diferentes estilos de música, aunque tengo preferencias musicales como el pop rock y el indie español. Mi grupo favorito de música es "El Canto del Loco", pero también me encantan "Miss Caffeina" y "Vetusta Morla". En esta sección, hablaré brevemente a cerca de estos tres grupos musicales.</Descriptions.Item>
                        <Descriptions.Item span={3}>
                            <Row gutter={ [30, 30] }>
                                { this.state.publicaciones.map( publicacion => {
                                    publicacion.linkTo = "/musica/" + publicacion.id;
